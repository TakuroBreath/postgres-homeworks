...
SELECT MIN(unit_price) FROM products WHERE discontinued <> 1;
...
SELECT MIN(unit_price) FROM products WHERE discontinued <> 1 AND units_in_stock >= 20;
SELECT MAX(unit_price) FROM products WHERE discontinued <> 1 AND units_in_stock >= 20;